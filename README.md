...
2. A forma tradicional: Caso prefira, também deixei disponível o arquivo `sistema_web.sql` na raiz (ou na pasta `/database`). Você pode importá-lo diretamente via phpMyAdmin ou terminal MySQL para garantir que a estrutura suba exatamente como planejado.
